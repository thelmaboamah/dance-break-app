  ...
  return (
    <PassageAuthGuard unAuthComp={<AuthRedirect />}>
      ...
      <section className="desktop:flex-1 px-64">
        ...
        <p className="pb-32">
        Get started using Dance Break by clicking <span className="italic">Go to Timer</span> below. 
        </p>
        <section className="flex justify-center">
          <Link to="/timer" className="primary-button flex justify-center" state={{ mode: "quiet" }}>
